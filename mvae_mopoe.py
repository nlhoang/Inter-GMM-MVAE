...
class MultiVAE(nn.Module):
    ...
    def encoder(self, vision=None, audio=None, tactile=None):
        ...
        mu, logvar = mixture_product_experts(self.latent_dim, mu_vision, logvar_vision, mu_audio, logvar_audio, mu_tactile, logvar_tactile)
...
def mixture_product_experts(dim, mu1, logvar1, mu2, logvar2, mu3, logvar3):
